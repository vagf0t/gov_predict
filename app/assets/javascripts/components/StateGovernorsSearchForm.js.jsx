var StateGovernorsSearchForm = createReactClass({
    handleSearch: function() {
        var state_governors_query = ReactDOM.findDOMNode(this.refs.state_governors_query).checked;
    ...
    render: function() {
        return(
            <input onChange={this.handleSearch}
                   ...
                   ref="state_governors_query"
                   id="state_governors_query_input"/>
        )
    }
});
