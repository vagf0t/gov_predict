var FederalAgencySearchForm = createReactClass({
    handleSearch: function() {
        var federal_agency_query = ReactDOM.findDOMNode(this.refs.federal_agency_query).checked;
    ...
    render: function() {
        return(
            <input onChange={this.handleSearch}
                   ...
                   ref="federal_agency_query"
                   id="federal_agency_query_input"/>
        )
    }
});
